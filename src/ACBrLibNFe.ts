...
import { ConsultRegistrationData, DFeDefaultData, DFeDistributionData, DFeDistributionKeyData, FileOrContentData, GenerateKeyData, GetConfigItemValueData, GetPathData, IACBrLibNFe, IACBrLibNFeResponse, MakeUnusableData, NFeCancelData, NFeConsultData, NFePositionData, NFeSaveData, NFeSendData, PrintData, ReadSaveImportConfigData, SaveConfigItemValueData, SendMailDefaultData, SendMailEventMailData, UnusablePrintSaveData } from "./IACBrLibNFe";
...
export class ACBrLibNFe implements IACBrLibNFe {
  ...
  makeUnusable(options: MakeUnusableData): IACBrLibNFeResponse {
    ...
    const data = NFeMakeUnusable(options.CNPJ, options.justification, options.year, options.model, options.serie, options.initialNumber, options.finalNumber, this.ACBrResponse, this.ACBrResponseLength);
  ...
  cancel(options: NFeCancelData): IACBrLibNFeResponse {
    ...
    const data = NFeCancel(options.NFeKey, options.justification, options.CNPJ, options.batchNumber, this.ACBrResponse, this.ACBrResponseLength);
  ...
  DFeDistribution(options: DFeDistributionData): IACBrLibNFeResponse {
    ...
    const data = NFeDFeDistribution(options.UFCode, options.CNPJCPF, options.NSU, options.fileOrContent, this.ACBrResponse, this.ACBrResponseLength);
  ...
  DFeDistributionLastNSU(options: DFeDefaultData): IACBrLibNFeResponse {
    ...
    const data = NFeDFeDistributionLastNSU(options.UFCode, options.CNPJCPF, options.NSU, this.ACBrResponse, this.ACBrResponseLength);
  ...
  DFeDistributionNSU(options: DFeDefaultData): IACBrLibNFeResponse {
    ...
    const data = NFeDFeDistributionNSU(options.UFCode, options.CNPJCPF, options.NSU, this.ACBrResponse, this.ACBrResponseLength);
  ...
  DFeDistributionKey(options: DFeDistributionKeyData) {
    ...
    const data = NFeDFeDistributionKey(options.UFCode, options.CNPJCPF, options.key, this.ACBrResponse, this.ACBrResponseLength);
