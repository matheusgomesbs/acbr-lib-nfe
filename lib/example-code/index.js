...
const ACBrLibPath = node_path_1.default.join(__dirname, 'bin', 'StdCall', 'ACBrNFe64.dll');
const ACBrFileConfigINI = node_path_1.default.join(__dirname, 'bin', 'ACBrLib.ini');
const XMLFile = node_path_1.default.join(__dirname, 'lib', 'xml', 'test-save.xml');
const eventXMLFile = node_path_1.default.join(__dirname, 'lib', 'xml', 'evento-teste-nfe.xml');
const eventINIFile = node_path_1.default.join(__dirname, 'lib', 'ini', 'evento-teste.ini');
const INIFile = node_path_1.default.join(__dirname, 'lib', 'ini', '01.ini');
const ACBrOptions = {
    fileConfigINI: ''
};
const NFe = new _index_1.ACBrLibNFe({
    ACBrLibPath: '',
    ACBrOptions
});
